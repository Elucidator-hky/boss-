...
本项目**仅供学习和个人求职使用**。使用者需自行遵守 Boss 直聘的服务条款——平台通常禁止自动化操作，**使用本工具存在账号被封禁的风险**。

**因使用本工具产生的任何后果（包括但不限于账号被封、数据丢失、其它损失），由使用者自行承担，作者不承担任何责任。**

禁止用于大规模爬取、数据倒卖、商业化、群发骚扰等用途。是否使用、如何使用，请自行判断风险。
